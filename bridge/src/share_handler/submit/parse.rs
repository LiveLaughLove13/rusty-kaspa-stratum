...
pub(super) fn prepare(
    ...
    let job_id = match &event.params[1] {
        serde_json::Value::String(s) => {
            ...
            s.parse::<u64>()
                .map_err(|e| SubmitError::JobIdParse(e.to_string()))?
        }
    ...
    let nonce_str = event.params[nonce_param_idx]
        .as_str()
        .ok_or(SubmitError::NonceNotString)?;
